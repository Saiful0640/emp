...
public class PayrollReport extends javax.swing.JFrame {
   Connection conn = null;
    ...
    try{
        ...
        rs=pst.executeQuery();
        tableallowance.setModel(DbUtils.resultSetToTableModel(rs));
    }
    catch(Exception e){
    Logger.getLogger(PayrollReport.class.getName()).log(Level.SEVERE, null, e);
    }
    finally {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PayrollReportPage pr = new PayrollReportPage();
        pr.setVisible(true);
